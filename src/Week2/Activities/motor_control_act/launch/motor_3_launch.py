...
def generate_launch_description():
    # USER VARIABLES
    package = "motor_control_act"  # Package to be launched
    ...
    talker_listener_launch_3 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [
                os.path.join(
                    get_package_share_directory("motor_control_act"), "launch"
                ),
                "/motor_launch.py",
            ]
        )
    ...
    motor_control_act_group1 = GroupAction(
        actions=[
    ...
    motor_control_act_group2 = GroupAction(
        actions=[
    ...
    motor_control_act_group3 = GroupAction(
        actions=[
    ...
    l_d = LaunchDescription(
        [motor_control_act_group1, motor_control_act_group2, motor_control_act_group3]
    )
